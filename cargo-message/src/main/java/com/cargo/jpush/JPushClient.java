...
import com.cargo.jpush.push.CIDResult;
import com.cargo.jpush.push.PushClient;
import com.cargo.jpush.push.PushResult;
import com.cargo.jpush.push.model.Message;
import com.cargo.jpush.push.model.Platform;
import com.cargo.jpush.push.model.PushPayload;
import com.cargo.jpush.push.model.SMS;
import com.cargo.jpush.push.model.audience.Audience;
import com.cargo.jpush.push.model.notification.BatchPushResult;
import com.cargo.jpush.push.model.notification.IosAlert;
...
//        _scheduleClient = new ScheduleClient(masterSecret, appKey);
     ...
     */
    public JPushClient(String masterSecret, String appKey, HttpProxy proxy, cn.jiguang.common.ClientConfig conf) {
...
//        _scheduleClient = new ScheduleClient(masterSecret, appKey, maxRetryTimes, proxy);
     ...
     */
    @Deprecated
    public JPushClient(String masterSecret, String appKey, int maxRetryTimes, HttpProxy proxy, cn.jiguang.common.ClientConfig conf) {
...
//        _scheduleClient = new ScheduleClient(masterSecret, appKey, proxy, conf);
    ...
    public JPushClient(String masterSecret, String appKey, boolean apnsProduction, long timeToLive) {
        cn.jiguang.common.ClientConfig conf = ClientConfig.getInstance();
        conf.setApnsProduction(apnsProduction);
        conf.setTimeToLive(timeToLive);
        _pushClient = new PushClient(masterSecret, appKey);
//        _reportClient = new ReportClient(masterSecret, appKey);
